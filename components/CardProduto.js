...
class CardProduto {
  ...
  _buildHTML() {
    ...
    const isEsgotado = p.estoque && p.estoque.toLowerCase() === 'sem estoque';
    ...
    return `
      ...
      <div class="card-body">
        ...
        <div class="card-actions" style="display:flex; flex-direction:column; gap:8px;">
          ${isEsgotado ? `
            <button class="btn-primary card-btn" disabled style="background:#2a2a2a; border-color:#333; color:#777; cursor:not-allowed; display:flex; align-items:center; justify-content:center; gap:8px;">
          ...
          <a
            href="${detalhesHref}"
            class="btn-primary card-btn ripple-container"
